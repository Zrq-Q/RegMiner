...
//		 String path = System.getProperty("java.class.path"); int firstIndex =
//		 path.lastIndexOf(System.getProperty("path.separator")) + 1; int lastIndex =
//		 path.lastIndexOf(File.separator) + 1; path = path.substring(firstIndex,
//		  lastIndex); FileUtilx.log("env.pro " + path); pathx = path + File.separator +
//		  CONFIGPATH;
